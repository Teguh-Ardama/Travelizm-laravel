...
gj.grid.config = {
    base: {
         ...
         * If set to object, then the grid is going to use this object as settings for the <a href="https://api.jquery.com/jquery.ajax/" target="_new">jquery ajax</a> function.<br />
...
gj.tree.config = {
    base: {
         ...
         * If set to object, then the tree is going to use this object as settings for the <a href="https://api.jquery.com/jquery.ajax/" target="_new">jquery ajax</a> function.<br />
         ...
         * <script>
         *     var tree = $('#tree').tree({
         *         dataSource: [ { text: 'World', imageUrl: 'https://gijgo.com/content/icons/world-icon.png', children: [ { text: 'USA', imageUrl: 'https://gijgo.com/content/icons/usa-oval-icon.png' } ] } ]
         *     });
         * </script>
         ...
         *     var tree = $('#tree').tree({
         *         imageUrlField: 'icon',
         *         dataSource: [ { text: 'World', icon: 'https://gijgo.com/content/icons/world-icon.png', children: [ { text: 'USA', icon: 'https://gijgo.com/content/icons/usa-oval-icon.png' } ] } ]
         *     });
         * </script>
         */
...
gj.dropdown.config = {
    base: {
         ...
         * If set to object, then the dropdown is going to use this object as settings for the <a href="https://api.jquery.com/jquery.ajax/" target="_new">jquery ajax</a> function.<br />
